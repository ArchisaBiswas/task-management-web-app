...
// Form for creating a new task. Validates all fields on submit, then POSTs the task
// and immediately assigns it to the currently logged-in user in a second request.
const CreateTaskForm = () => {
  ...
  // Validates the form, creates the task, then assigns the current user to it.
  // The two-step sequence (create → assign) is required because task_id is only
  // known after the first POST.
